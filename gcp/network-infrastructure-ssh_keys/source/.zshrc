...
if [ -f /usr/bin/grc ]; then
  ...
  alias login="grc --colour=auto login"
  alias pass="grc --colour=auto pass"
  alias password="grc --colour=auto password"
  alias up="grc --colour=auto up"
  alias host="grc --colour=auto host"
fi
#==============================================
